...
def routertool(question):
    ...
    web_keywords = ['Wikipedia', 'Investment', 'Investment and Risk', 'Investment Strategies', 'Webpage', 'Wikipage']
...
def create_agents():
    Router_Agent = Agent(
        role='Router',
        goal='Route user question to a pdfvectorstore or wikipagevectorstore or imageanalysis or websearch. Only perform the action you have been asked to perform. Once you have found the information, immediately stop searching for additional information.',
        backstory=(
    ...
    PDFRAG_Agent = Agent(
        role="PDFRAG",
        goal="Use retrieved information to answer the question from PDF vectorstore. Only perform the action you have been asked to perform. Once you have found the information, immediately stop searching for additional information.",
        backstory=(
    ...
    WebpageRAG_Agent = Agent(
        role='WikipageRAG',
        goal="Use retrieved information to answer the question from Wikipage vectorstore. Only perform the action you have been asked to perform. Once you have found the information, immediately stop searching for additional information.",
        backstory=(
    ...
    ImageAnalysis_Agent = Agent(
        role="ImageProcessor",
        goal="Read image and give insights or summary. Only perform the action you have been asked to perform. Once you have found the information, immediately stop searching for additional information.",
        backstory=(
    ...
    Websearch_Agent = Agent(
        role="WebSearcher",
        goal="Provide a comprehensive and accurate response from across internet or web and not from vectorstore. Only perform the action you have been asked to perform. Once you have found the information, immediately stop searching for additional information.",
        backstory=(
...
def create_tasks(agents, tools):
    ...
    router_task = Task(
        description=(
            ...
            "Strictly don't give Action or Action Input and throw errors, ignore them. If Action or Action Input is required then give it in below format "
            "Action : only the tool name without any special characters like _ "
            "Action Input : no dictionary with only the summary of question"
            "Only perform the action you have been asked to perform. Once you have found the information, immediately stop searching for additional information."
        ),
    ...
    imageanalysis_task = Task(
        ...
        4. Strictly don't give Action or Action Input and throw errors, ignore them. If Action or Action Input is required then give it in below format 
            Action : only the tool name without any special characters like _ 
            Action Input : no dictionary with only the summary of question"
        5. Only perform the action you have been asked to perform. Once you have found the information, immediately stop searching for additional information
        """,
